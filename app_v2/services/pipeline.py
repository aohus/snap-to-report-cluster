...
from app_v2.services.metadata_extractor import MetadataExtractor
from app_v2.services.clustering.base import Clusterer, BaseDescriptorExtractor, BaseGeometryMatcher
from app_v2.services.clustering.gps import GPSClusterer
from app_v2.services.clustering.image import ImageClusterer
from app_v2.services.clustering.descriptors import APGeMDescriptorExtractor, CLIPDescriptorExtractor, CombinedAPGeMCLIPExtractor
from app_v2.services.clustering.geometry import SIFTMatcher, LoFTRMatcher
from app_v2.services.clustering.segmenter import SemanticSegmenter
from app_v2.services.clustering.people_detector import create_people_detector
...
class PhotoClusteringPipeline:
    ...
    def _create_descriptor_extractor(self) -> BaseDescriptorExtractor:
        # Currently hardcoding CombinedAPGeMCLIPExtractor as per experiment scripts
        return CombinedAPGeMCLIPExtractor(
            self.config,
